---
title: Saga Pattern
description: A deep-dive into how the Reefer Container Shipment solution reference implements Saga Patterns to support long-running transactions in event-driven architectures.
---
...
For more information about the SAGA pattern, read our specific section on it [here](https://ibm-cloud-architecture.github.io/refarch-eda/patterns/saga/).

In this readme, we are going to focus on the SAGA pattern implementation details for our [Reefer Container Shipment Reference Application](/).
