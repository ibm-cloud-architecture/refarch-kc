...
- [Happy path](../happy-path/) - End to end happy path test.
- [SAGA pattern](../saga-pattern/) - SAGA pattern for new order creation test.
- [Order Cancellation](../order-cancellation/) - Order Cancellation test.
- [Container Anomaly](../container-anomaly/) - Container anomaly and maintenance test.
- [Dead Letter Queue](../dead-letter-queue/) - Container Anomaly Dead Letter Queue Pattern test.
...
1. Backing services such as IBM Event Streams and PostgreSQL - Instructions [here](../../microservices/prereqs/).
2. The Reefer container shipment solution components - Instructions [here](../../implementation/gitops/).
