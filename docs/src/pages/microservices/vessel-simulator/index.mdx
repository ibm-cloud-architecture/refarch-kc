...
<InlineNotification kind="info"><strong>TODO</strong> source vessel-simulator overview details from https://github.com/ibm-cloud-architecture/refarch-kc-vessel-simulator</InlineNotification>
