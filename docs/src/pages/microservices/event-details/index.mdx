...
Data Schema: **TODO** Define [`Container Metric Event`](https://github.com/ibm-cloud-architecture/refarch-kc-ms/blob/master/fleet-ms/src/main/java/ibm/labs/kc/event/model/ContainerMetric.java) schema
...
Data Schema: **TODO** Define [`Ship Position Event`](https://github.com/ibm-cloud-architecture/refarch-kc-ms/blob/master/fleet-ms/src/main/java/ibm/labs/kc/event/model/ShipPosition.java) schema
...
Data Schema: **TODO** Define [`Bluewater Problem Event`](https://github.com/ibm-cloud-architecture/refarch-kc-ms/blob/master/fleet-ms/src/main/java/ibm/labs/kc/event/model/BluewaterProblem.java) schema
