...
<InlineNotification kind="warning">UNDER CONSTRUCTION - Needs Topic & Event Specifics</InlineNotification>
...
| KAFKA_BW_PROBLEM_TOPIC_NAME              | YES      | The topic name used for communication relating to the bluewater problem  actions.                                                                                                                       |
