...
This is a common occurrence in agile development and it may be helpful to show how decision to scope and simplify a particular build and test step interract with decisions relating strictly to microservices design.  
