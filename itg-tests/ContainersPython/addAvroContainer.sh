...
echo -e " \e[32m@@@ Executing script: \e[1;33maddAvroContainer.sh \e[0m"
...
# We are running the ProduceAvroContainer.py python script into a python enabled container
...
docker run  -e KAFKA_BROKERS=$KAFKA_BROKERS \
            ...
            -c "cd /refarch-kc/itg-tests/ContainersPython && \
                ...
                python ProduceAvroContainer.py $cid $topic_name"
